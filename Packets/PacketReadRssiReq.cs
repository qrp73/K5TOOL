...
{
    public class PacketReadRssiReq : Packet
    {
        public const ushort ID = 0x0527;

        public PacketReadRssiReq(byte[] rawData)
            : base(rawData)
        {
            if (base.HdrId != ID)
        ...
        public PacketReadRssiReq()
            : base(new byte[] { 0x27, 0x05, 0x00, 0x00 })
        {
        }
