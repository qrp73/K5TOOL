...
{
    public class PacketRebootReq : Packet
    {
        public const ushort ID = 0x05dd;

        public PacketRebootReq(byte[] rawData)
            : base(rawData)
        {
            if (base.HdrId != ID)
        ...
        public PacketRebootReq()
            : base(new byte[] { 0xdd, 0x05, 0x00, 0x00 })
        {
        }
